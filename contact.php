            ...
            <div class="container">
                <div class="contact-content">
                    <div class="contact-info">
                        ...
                        <p class="contact-text" data-elem="contact.infoText">Si tienes alguna pregunta o necesitas
                            ayuda, no
                    ...
                    <div class="contact-form-container">
                        ...
                        <form class="contact-form" id="contactForm">
                            ...
                            <button type="submit" class="btn btn-primary btn-block"
                                data-elem="contact.form.submit">Enviar
                                mensaje</button>
                        </form>
                        ...
                        <div class="form-success" id="formSuccess">
                            ...
                            <p data-elem="contact.form.successMessage">Gracias por contactarnos. Te responderemos lo
                                antes
                                posible.</p>
                        </div>
                    </div>
                ...
                <div class="footer-content">
                    <div class="footer-brand">
                        ...
                        <p class="footer-description" data-elem="footer.description">Tu herramienta para una gestión
                            ...
                            Arboleda.</p>
                        <div class="social-links">
                            <a href="https://github.com/Ballwictb/FinanzApp" class="social-link"><i
                                    class="fab fa-github"></i></a>
                            <a href="https://finanzapp.es" class="social-link"><i
                                    class="fa-light fa-globe-pointer"></i></a>
                        </div>
                    </div>
